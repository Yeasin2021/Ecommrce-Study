...
<head>
    ...
    <!-- jQuery -->
    <script src="{{ asset('front-end/js/') }}/jquery-2.0.0.min.js" type="text/javascript"></script>

    <!-- Bootstrap4 files-->
    <script src="{{ asset('front-end/js/') }}/bootstrap.bundle.min.js" type="text/javascript"></script>
    <link href="{{ asset('front-end/css/') }}/bootstrap.css?v=1.0" rel="stylesheet" type="text/css" />

    <!-- Font awesome 5 -->
    <link href="{{asset('front-end/')}}/fonts/fontawesome/css/fontawesome-all.min.css" type="text/css" rel="stylesheet">

    <!-- plugin: fancybox  -->
    <script src="{{asset('front-end/')}}/plugins/fancybox/fancybox.min.js" type="text/javascript"></script>
    <link href="{{asset('front-end/')}}/plugins/fancybox/fancybox.min.css" type="text/css" rel="stylesheet">

    <!-- plugin: owl carousel  -->
    <link href="{{asset('front-end/')}}/plugins/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="{{asset('front-end/')}}/plugins/owlcarousel/assets/owl.theme.default.css" rel="stylesheet">
    <script src="{{asset('front-end/')}}/plugins/owlcarousel/owl.carousel.min.js"></script>

    <!-- custom style -->
    <link href="{{ asset('front-end/css/') }}/ui.css?v=1.0" rel="stylesheet" type="text/css" />
    <link href="{{ asset('front-end/css/') }}/responsive.css" rel="stylesheet" media="only screen and (max-width: 1200px)" />

    <!-- custom javascript -->
    <script src="{{ asset('front-end/js/') }}/script.js" type="text/javascript"></script>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="brand-wrap">
                            <img class="logo" src="{{ asset('front-end/images/') }}/logo-dark.png">
                ...
                <div class="col-md-9">
                    ...
                    <div class="owl-init slider-main owl-carousel" data-items="1" data-dots="false" data-nav="true">
                        <div class="item-slide">
                            <img src="{{ asset('front-end/images/') }}/banners/slide1.jpg">
                        </div>
                        <div class="item-slide rounded">
                            <img src="{{ asset('front-end/images/') }}/banners/slide2.jpg">
                        </div>
                        <div class="item-slide rounded">
                            <img src="{{ asset('front-end/images/') }}/banners/slide3.jpg">
                        </div>
                    </div>
                    <!-- ============== main slidesow .end // ============= -->
                </div>
                ...
                <div class="col-md-3">
                    <div class="card mt-2 mb-2">
                        <figure class="itemside">
                            <div class="aside">
                                <div class="img-wrap img-sm border-right"><img src="{{ asset('front-end/images/') }}/items/3.jpg"></div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <figure class="card card-product">
                        <div class="img-wrap"><img src="{{ asset('front-end/images/') }}/items/1.jpg"></div>
                ...
                <div class="col-md-4">
                    <figure class="card card-product">
                        <div class="img-wrap"><img src="{{ asset('front-end/images/') }}/items/2.jpg"> </div>
                        <figcaption class="info-wrap">
                ...
                <div class="col-md-4">
                    <figure class="card card-product">
                        <div class="img-wrap"><img src="{{ asset('front-end/images/') }}/items/3.jpg"></div>
                        <figcaption class="info-wrap">
